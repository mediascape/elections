...
define(["mediascape/AdaptationToolkit/adaptation/UIAdaptation/layoutConstructor"],
  function(LayoutConstructor){
    ...
    divided.render = function (cmps){
      ...
      var widthCont=window.innerWidth ||document.documentElement.clientWidth ||document.body.clientWidth;
      ...
      if(ordered_cmps.length===1){
        ...
        for(var i=0;i<ordered_cmps.length;i++){
          ...
          if(widthCont>992){
            ...
            if(i<ordered_cmps.length/2){
              ordered_cmps[i].style.top='0%';
            }
            else{
              ordered_cmps[i].style.top='50%';
            }
          }
        ...
        for(var i=0;i<ordered_cmps.length;i++){          
          ...
          if(widthCont>992){
            ordered_cmps[i].style.position='absolute';
            ordered_cmps[i].style.top=Math.floor(i/3)*50+'%';
            ordered_cmps[i].style.left=((i-(Math.floor(i/3)*3))*33.333333)+'%';
          }
        ...
        for(var i=0;i<ordered_cmps.length;i++){          
          ...
          if(widthCont>992){
            ordered_cmps[i].style.position='absolute';
            ordered_cmps[i].style.top=Math.floor(i/3)*33.333333+'%';
            ordered_cmps[i].style.left=((i-(Math.floor(i/3)*3))*33.333333)+'%';
          }
