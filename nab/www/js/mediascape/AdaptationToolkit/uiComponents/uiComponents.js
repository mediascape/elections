    ...
    uiComponents = function uiComponents(atk,i,atk){
      ...
      //Console.log();
        ...
        this.unSupportedDevice = function (){
            ...
            p.innerHTML = "Zure Telebista ez da konputagarria / La TV no es compatible con la app";
       ...
       this.prompt = function (config){
        ...
        this.qrNotification=function(l,devType){
          img=document.createElement('img');
          img.id='qrNotif';
          if(devType==='tv'){
            img.src='../resources/images/qrTVnotif'+l+'.png';
          }
          else{
            img.src='../resources/images/qrPCnotif'+l+'.png';
          }
          img.style.position="absolute";
          img.style.bottom='5%';
          img.style.right='5%';
          ...
          img.onclick=function(){
            ...
            document.body.removeChild(document.querySelector('#qrNotif'));
        ...
        this.connectedNotification=function(l){
          img=document.createElement('img');
          img.id='conn';
          img.src='../resources/images/Connected'+l+'.png';
          img.style.position="absolute";
          img.style.bottom='5%';
          img.style.right='5%';
        ...
        this.loadingNotification=function(){
          document.querySelector('#loadingNotif').style.display='block';
        }
        this.unloadingNotification=function(){
          document.querySelector('#loadingNotif').style.display='none';
        }
        this.disconnectedNotification=function(l){
          img=document.createElement('img');
          img.id='disc';
          img.src='../resources/images/Disconnected'+l+'.png';
          img.style.position="absolute";
          img.style.bottom='5%';
          img.style.right='5%';
          img.style.zIndex="99999";
      ...
      this.addControlPanel = function (url){
        ...
        var updateQR=_.debounce(function(event){
            if(document.querySelector('.qr-code-content')){
                ...
                mediascape.association.doAssociation('qr','qr-code-content', url, true,(30*width/100),(30*width/100),leftMargin,00);
        ...
        nav.id='cbp-spmenu-s4';
          ...
          div1.className='controller_caja';
            ...
            div6.className='botonera col-lg-4 col-md-5 col-sm-6';
              ...
              img3.src='../resources/configPanel/img/controller/rew_izda.png';
              ...
              img6.width=107;
              img6.src='../resources/configPanel/img/controller/rew_dcha.png';
