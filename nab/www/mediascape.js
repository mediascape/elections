...
(function init() {
  ...
  require.config({
    ...
    domReady:'/resources/libs/domReady',
    swiper:'http://cdnjs.cloudflare.com/ajax/libs/Swiper/3.3.0/js/swiper.min',
    ...
    bootstrap_swicth:'http://cdnjs.cloudflare.com/ajax/libs/bootstrap-switch/3.3.2/js/bootstrap-switch.min',
    webcomponetsPolyfill:'http://cdnjs.cloudflare.com/ajax/libs/webcomponentsjs/0.7.17/webcomponents-lite.min'
      },
    waitSeconds:25
  });
