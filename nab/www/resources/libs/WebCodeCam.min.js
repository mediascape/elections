...
*/
define('webcodecam',['jquery'],
function($,bootstrap){

(function(n,C,H,I){function D(b,a){this.element=b;t=n(b);this.options=n.extend({},E,a);this._defaults=E;this._name="WebCodeCam";this.init()&&(this.setEventListeners(),(this.options.ReadQRCode||this.options.ReadBarecode)&&this.setCallback())}var a,u,k,t,h,g,l={},e=n('<video style="position:absolute;visibility:hidden;display: none;">')[0],v=!1,F=!1,G=new Worker("js/lib/DecoderWorker.js"),m=!1,E={ReadQRCode:!0,ReadBarecode:!0,width:320,height:240,videoSource:{id:!0,maxWidth:640,maxHeight:480},flipVertical:!1,
...
typeof a.options.beep){var b=a.options.beep;setTimeout(function(){(new Audio(b)).play()},0)}}};n.fn.WebCodeCam=function(a){return this.each(function(){n.data(this,"plugin_WebCodeCam")||n.data(this,"plugin_WebCodeCam",new D(this,a))})}})($,window,document);
});
