...
(function () {
    ...
    elproto.getRegion = function (paper) {
        return paper.opts.region;
    };
    elproto.getData= function () {
        return paper.opts.data;
    };            
    ...
    elproto.move = function (f_in,scope_in) {
        return this.mousemove(f_in, scope_in);
    };
    ...
    paperproto.getRegion = function (){
        return this.opts.region;
    };
    paperproto.getData = function (){
...
window.Raphael.svg && function (R) {
    ...
    elproto.resetScale = function (){
        ...
        this.matrix.add(this.oldMatrix.a,this.oldMatrix.b,this.oldMatrix.c,this.oldMatrix.d,this.oldMatrix.e,this.oldMatrix.f);
    };
    ...
    elproto.scale = function (sx, sy, cx, cy) {
        ...
        if (typeof this.oldMatrix=='undefined'){
...
Raphael.fn.disc = function (cx, cy, r) {
